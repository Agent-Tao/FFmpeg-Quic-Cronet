	...
	do
		...
		then
			...
			LDFLAGS="$LDFLAGS -L$FDK_AAC/lib"
                ...
                mv $CWD/$SOURCE/configure $CWD/$SOURCE/configure.bak
                mv $CWD/$SOURCE/configure_ios $CWD/$SOURCE/configure
		...
		TMPDIR=${TMPDIR/%\/} $CWD/$SOURCE/configure \
		    ...
		    --as="$AS" \
		    $CONFIGURE_FLAGS \
		    --extra-cflags="$CFLAGS -I/Users/testtest/hezhen/google/chromium/src/components/cronet/native/include -I/Users/testtest/hezhen/google/chromium/src/components/cronet/native/generated" \
		...
		|| exit 1
                ...
                mv $CWD/$SOURCE/configure $CWD/$SOURCE/configure_ios
                mv $CWD/$SOURCE/configure.bak $CWD/$SOURCE/configure
